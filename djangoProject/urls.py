...
router.register(r'artifactenrichment',
                views.ArtifactEnrichmentViewSet, basename='artifactenrichment')
router.register(r'artifactrelation',
                views.ArtifactRelationViewSet, basename='artifactrelation')
...
router.register(r'stringidentifier', views.StringIdentifierViewSet,
                basename='stringidentifier')
...
urlpatterns = [
    ...
    path('api/ctoken/', views.CookieTokenObtainPairView.as_view(),
         name='ctoken-create'),
    path('api/ctoken/refresh/', views.CookieTokenRefreshView.as_view(),
         name='ctoken-refresh'),
    path('api/ctoken/logout/', views.CookieTokenLogoutView.as_view(),
         name='ctoken-logout'),
