...
router.register(r'communicationchannel', views.CommunicationChannelViewSet, basename='communicationchannel')
router.register(r'communication_type', views.CommunicationTypeViewSet, basename='communicationtype')
...
router.register(r'minified/taxonomygroup', views.TaxonomyGroupMinifiedViewSet, basename='minified-taxonomygroup')
...
router.register(r'minified/artifact', views.ArtifactMinifiedViewSet, basename='minified-artifact')
...
urlpatterns = [
    ...
    path(
        "api/user/<int:pk>/audit/", views.tools.UserAuditsListView.as_view({"get": "list"}), name="user-logentry-list"
    ),
    ...
    path("api/dashboard/events", views.dashboards.events.DashboardEventsView.as_view(), name="dashboard-events"),
    path("api/dashboard/cases", views.dashboards.cases.DashboardCasesView.as_view(), name="dashboard-cases"),
    path("api/dashboard/feeds", views.dashboards.feeds.DashboardFeedsView.as_view(), name="dashboard-feeds"),
    path(
