        ...
        if "duplicate key value violates unique constraint" in error_message:
            try:
                ...
                return Response(
                    ...
                    data={
                        key: [f"Ya existe una entidad {klass} con {key}={value}."],
                        "_detail": error_message,
                    },
                )
            except:
                return Response(
                    status=status.HTTP_400_BAD_REQUEST, data={"error": [error_message]}
                )
        elif (
            "update or delete on table" in error_message
            ...
            return Response(
                ...
                data={
                    "__all__": [
                        f"No se puede editar y/o eliminar la entidad porque hay objetos que dependen de ella."
                    ],
                    "_detail": error_message,
                },
            )
