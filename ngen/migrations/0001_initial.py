# Generated by Django 4.0.8 on 2023-03-24 13:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='assigned_cases', to=settings.AUTH_USER_MODEL)),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='children', to='ngen.case')),
            ],
            options={
                'db_table': 'case',
            },
            bases=(django_lifecycle.mixins.LifecycleModelMixin, models.Model, ngen.communication.Communication),
        ),
        migrations.CreateModel(
            name='Contact',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('case', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events', to='ngen.case')),
            ],
            options={
                'db_table': 'event',
                'ordering': ['-id'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attend_deadline', models.DurationField(default=datetime.timedelta(days=1))),
                ('solve_deadline', models.DurationField(default=datetime.timedelta(days=2))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('type', models.CharField(choices=[('vulnerability', 'Vulnerability'), ('incident', 'Incident')], default='vulnerability', max_length=20)),
                ('name', models.CharField(max_length=100)),
                ('slug', models.SlugField(max_length=100, unique=True)),
                ('active', models.BooleanField(default=True)),
                ('description', models.TextField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('network_entity', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='ngen.networkentity')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='ngen.case')),
        ...
        migrations.AddField(
            model_name='event',
            name='reporter',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='events_reporter', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='event',
            name='tasks',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(default=True)),
                ('case_state', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='decision_states', to='ngen.state')),
                ...
                ('event_taxonomy', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='ngen.taxonomy')),
                ('priority', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='ngen.priority')),
            ],
            options={
