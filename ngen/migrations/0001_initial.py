    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            bases=(
                ...
                ngen.models.announcement.Communication,
                models.Model,
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    netfields.fields.CidrAddressField(
                        blank=True, default=None, max_length=43, null=True
                    ),
                ),
                (
                    "domain",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "children",
                    models.ManyToManyField(
                        related_name="parents", through="ngen.Edge", to="ngen.state"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        null=True,
                        storage=ngen.storage.HashedFilenameStorage(),
                        unique=True,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="ngen.feed"
            ),
        ),
        migrations.AddField(
            model_name="event",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="events", through="ngen.TodoTask", to="ngen.task"
            ),
        ),
        migrations.AddField(
            model_name="event",
            name="taxonomy",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="ngen.taxonomy"
            ),
        ),
        migrations.AddField(
            model_name="event",
            name="tlp",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="ngen.tlp"
            ),
        ),
        migrations.AddField(
            model_name="edge",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "network",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="ngen.network"
                    ),
                ),
                (
                    "priority",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="artifact_relation",
                        to="ngen.artifact",
                    ),
                ),
                (
