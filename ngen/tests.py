...
class ConstituencyTest(TestCase):
    ...
    def setUp(cls):
        ...
        Network.objects.create(cidr='163.10.2.1/32')
        Network.objects.create(cidr='163.10.2.2/32')
        Network.objects.create(cidr='163.10.2.3/32')
        Network.objects.create(domain='ar')
        Network.objects.create(domain='edu.ar')
        Network.objects.create(domain='unlp.edu.ar')
        Network.objects.create(domain='info.unlp.edu.ar')
        Network.objects.create(domain='cert.unlp.edu.ar')
        Network.objects.create(domain='servicios.cert.unlp.edu.ar')
        Network.objects.create(cidr='2001:db8::/32')
        Network.objects.create(cidr='2001:db8:3c4d::/48')
        Network.objects.create(cidr='2001:db8:3c4d:15::/64')
        Network.objects.create(cidr='2001:db8:3c4d:0015:0000:0000:1a2f:1a2b/128')
