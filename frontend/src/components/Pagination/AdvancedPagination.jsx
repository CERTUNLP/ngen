  ...
  return (
    <Pagination>
      {currentPage === 1 ?
        ...
        :
        <Pagination.First disabled={disabledPagination}
      ...
      {currentPage === 1 ?
        ...
        :
        <Pagination.Prev disabled={disabledPagination}
                         onClick={() => arrayPagesPrev()}/>
      }
      {arrayPages.map(page => (
        (page === currentPage) ?
      ...
      {currentPage === lastPage ?
        ...
        :
        <Pagination.Next disabled={disabledPagination}
                         onClick={() => arrayPagesNext()}/>
      }
      {currentPage === lastPage ?
        <Pagination.Last disabled/>
        :
        <Pagination.Last disabled={disabledPagination}
