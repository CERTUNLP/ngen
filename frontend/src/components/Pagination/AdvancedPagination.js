...
const AdvancedPagination = ({ countItems, updatePage, updatePagination, setUpdatePagination, setLoading, disabledPagination, setDisabledPagination, parentCurrentPage = -1, ifModify=true }) => {
  ...
  }, [currentPage, countItems, lastPage, updatePagination, pageSize]);
