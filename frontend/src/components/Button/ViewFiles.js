...
const ViewFiles = (props) => {
  ...
  const removeCase = (file) => {
    if (file.url) {
      deleteEvidence(file.url).then((response) => {
        ...
        <Card.Body>
          <div className="file-info">
            ...
            >
              ...
              <div>
                <p
                  className="file-name">{props.file.original_filename ? props.file.original_filename.slice(0, 20) + "... " : ""
                ...
                <p className="file-meta">
                  Fecha de
                  creación: {props.file.created ? props.file.created.slice(0, 10) + " " + props.file.created.slice(11, 19) : "No creado en el sistema"}
                </p>
              </div>
            </div>
            {props.disableDelete ? "" :
