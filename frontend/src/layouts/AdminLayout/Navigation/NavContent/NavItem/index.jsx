...
const NavItem = ({ item }) => {
  ...
  if (item.external) {
    ...
    subContent = item.basic_link ? (
      <Link to={item.url} className="nav-link" target={itemTarget} onClick={item.onClick}>
        <NavIcon items={item} />
        {itemTitle}
        <NavBadge items={item} />
      </Link>
    ) : (
      <NavLink to={item.url} className="nav-link" target={itemTarget} onClick={item.onClick}>
        <NavIcon items={item} />
        {itemTitle}
        <NavBadge items={item} />
      </NavLink>
