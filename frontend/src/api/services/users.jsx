...
const getMinifiedUser = () => {//el parametro es para completar la url con el numero de pagina
  ...
  return apiInstance.get(COMPONENT_URL.userMinifiedList).then(response => {
...
const getUsers = (currentPage, filters, order) => {//el parametro es para completar la url con el numero de pagina
  ...
  return apiInstance.get(
    COMPONENT_URL.user + PAGE + currentPage + '&ordering=' + order + '&' +
...
const postUser = (
  username, first_name, last_name, email, priority, is_active, password) => {
...
const putUser = (
  url, username, first_name, last_name, email, priority, is_active) => {
...
const isActive = (url, active) => {
  ...
  return apiInstance.patch(url, {
    ...
    if (error.message ===
      ...
      //el backend o servidor no funciona
      messageError = !active
        ? `El usuario no pudo ser desactivado no pudo ser`
        : `El usuario no pudo ser activado no pudo ser`
      setAlert(messageError, 'error')
