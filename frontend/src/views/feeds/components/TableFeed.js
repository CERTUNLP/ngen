  ...
  return (
    <div>
      <Card.Body>
        ...
        <ModalConfirm type='delete' component={t('ngen.feed.information')} name={deleteName} showModal={remove}
                      onHide={() => setRemove(false)} ifConfirm={() => handleDelete(deleteUrl)}/>
        <ModalConfirm type='editState' component={t('ngen.feed.information')} name={dataState.name}
                      state={dataState.state} showModal={showState} onHide={() => setShowState(false)}
