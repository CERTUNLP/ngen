...
const ListFeed = () => {
  ...
  useEffect(() => {
    getFeeds(currentPage, wordToSearch, order).then((response) => {
        ...
        <Col>
          <Card>
            <Card.Header>
              <Row>
                <Col sm={12} lg={9}>
                  <Search type={t('search.by.name.description')} setWordToSearch={setWordToSearch}
            ...
            <TableFeed feeds={feeds} loading={loading} order={order} setOrder={setOrder} setLoading={setLoading}
