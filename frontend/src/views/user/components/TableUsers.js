    ...
    <div>
      ...
      <ul className="list-group my-4">
        <Table responsive hover className="text-center">
          <thead>
          <tr>
            <Ordering field="username" label={t('ngen.user.username')} order={order} setOrder={setOrder}
                      setLoading={setLoading} letterSize={letterSize}/>
            <Ordering field="email" label={t('w.email')} order={order} setOrder={setOrder} setLoading={setLoading}
          ...
          <ModalConfirm type='delete' component={t('ngen.user')} name={deleteUsername} showModal={remove}
                        onHide={() => setRemove(false)} ifConfirm={() => handleDelete(deleteUrl)}/>
          <ModalConfirm type='editState' component={t('ngen.user')} name={dataState.username} state={dataState.state}
                        ...
                        <tr>
                          ...
                          <td>
                            <Button
                              ...
                              <i
                                className={user.is_active ? 'feather icon-check-circle' : 'feather icon-alert-triangle'}/>
                            </Button>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <Form.Control plaintext readOnly
                                          defaultValue={user.last_login ? user.last_login.slice(0, 10) : ""}/>
                          </td>
                        </tr>
                        <tr>
