  ...
  return (
    <Form>
      <Row>
        ...
        <Col sm={12} lg={3}>
          <SelectComponent controlId="exampleForm.ControlSelect1" label="Prioridades" options={priorities}
      ...
      <Row>
        <Col sm={12} lg={6}>
          <Form.Group className="mb-3" controlId="formBasicPassword">
            <Form.Label>{t('ngen.password')} {passwordRequired ? <b style={{ color: "red" }}>*</b> : ""}</Form.Label>
            <Form.Control
              type="password"
