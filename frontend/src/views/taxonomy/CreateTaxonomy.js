...
const CreateTaxonomy = () => {
  ...
  const createTaxonomy = () => {
    postTaxonomy(type, name, description, active, parent, alias_of, needs_review, group).then(() => {
  ...
  return (
    <React.Fragment>
      ...
      <Row>
        <Navigation actualPosition={t('w.add') + " " + t('ngen.taxonomy_one')} path="/taxonomies"
