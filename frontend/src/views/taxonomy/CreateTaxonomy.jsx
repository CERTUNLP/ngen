...
const CreateTaxonomy = () => {
  ...
  const createTaxonomy = () => {
    postTaxonomy(type, name, description, active, parent, alias_of,
  ...
  return (
    <React.Fragment>
      <Alert showAlert={showAlert} resetShowAlert={resetShowAlert}
             component="taxonomy"/>
      <Row>
        <Navigation actualPosition={t('w.add') + ' ' + t('ngen.taxonomy_one')}
                    path="/taxonomies"
                    index={t('ngen.taxonomy_other')}/>
      </Row>
      <Row>
        <Col sm={12}>
          <Card>
              ...
              <Form>
                ...
                <Row>
                  <Col sm={12} lg={4}>
                    <SelectLabel set={handleParentChange}
                                 ...
                                 legend={t(
                                   'ngen.taxonomy.parent.legend.create')}/>
                  </Col>
                  <Col sm={12} lg={4}>
                    <SelectLabel set={setGroup} setSelect={setSelectGroup}
                                 ...
                                 disabled={isGroupDisabled} legend={t(
                      'ngen.taxonomy.group.legend.create')}/>
                  </Col>
                  <Col sm={12} lg={4}>
                    <SelectLabel set={setAlias_of}
                ...
                <Form.Group as={Col}>
                  {validateType(type) && validateName(name) && name !== '' ?
                    <Button variant="primary" onClick={createTaxonomy}>{t(
                      'button.save')}</Button>
                    :
