...
import {deleteTaxonomy, getMinifiedTaxonomy, getTaxonomy} from '../../../api/services/taxonomies';
      ...
      <Table responsive hover className="text-center">
        <thead>
          <tr>
            ...
            <Ordering field="group__name" label={t('ngen.taxonomy.group')} order={order} setOrder={setOrder} setLoading={setLoading} letterSize={letterSize} />
            <Ordering field="alias_of__name" label={t('ngen.taxonomy.alias_of')} order={order} setOrder={setOrder} setLoading={setLoading} letterSize={letterSize} />
            <Ordering field="needs_review" label={t('ngen.taxonomy.needs_review')} order={order} setOrder={setOrder} setLoading={setLoading} letterSize={letterSize} />
            <Ordering field="reports" label={t('ngen.reports')} order={order} setOrder={setOrder} setLoading={setLoading} letterSize={letterSize} />
                  ...
                  <Table responsive>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            <Form.Control plaintext readOnly defaultValue={taxonomy ? taxonomy.needs_review ? t('w.yes') : t('w.no') : ""} />
                        </td>
                      </tr>
                      <tr>
                        <td>{t('ngen.type')}</td>
