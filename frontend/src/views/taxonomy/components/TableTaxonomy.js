...
const TableTaxonomy = ({
  ...
  const removeTaxonomy = (url, name) => {
    deleteTaxonomy(url, name).then((response) => {
  ...
  return (
    <React.Fragment>
      <Table responsive hover className="text-center">
        <thead>
        <tr>
          <Ordering field="created" label={t('date.creation')} order={order} setOrder={setOrder} setLoading={setLoading}
                    letterSize={letterSize}/>
          <Ordering field="name" label={t('ngen.name_one')} order={order} setOrder={setOrder} setLoading={setLoading}
                    letterSize={letterSize}/>
          <Ordering field="type" label={t('ngen.taxonomy.type')} order={order} setOrder={setOrder}
                    setLoading={setLoading} letterSize={letterSize}/>
          <Ordering field="parent__name" label={t('ngen.taxonomy.parent')} order={order} setOrder={setOrder}
                    setLoading={setLoading} letterSize={letterSize}/>
          <Ordering field="group__name" label={t('ngen.taxonomy.group')} order={order} setOrder={setOrder}
                    setLoading={setLoading} letterSize={letterSize}/>
          <Ordering field="alias_of__name" label={t('ngen.taxonomy.alias_of')} order={order} setOrder={setOrder}
                    setLoading={setLoading} letterSize={letterSize}/>
          <Ordering field="needs_review" label={t('ngen.taxonomy.needs_review')} order={order} setOrder={setOrder}
                    setLoading={setLoading} letterSize={letterSize}/>
          <Ordering field="reports" label={t('ngen.reports')} order={order} setOrder={setOrder} setLoading={setLoading}
                    letterSize={letterSize}/>
                  ...
                  <Table responsive>
                      ...
                      <tr>
                        ...
                        <td>
                          <Form.Control plaintext readOnly
                                        defaultValue={taxonomy ? taxonomyGroups[taxonomy.group] : ""}/>
                        </td>
                      </tr>
                    )}
                    {taxonomy && taxonomy.alias_of && (
                      <tr>
                        ...
                        <td>
                          <Form.Control plaintext readOnly
                                        defaultValue={taxonomy ? minifiedTaxonomies[taxonomy.alias_of] : ""}/>
                        </td>
                      </tr>
                    )}
                    <tr>
                    ...
                    {taxonomy && Boolean(taxonomy.description) && (
                      <tr>
                        ...
                        <td>
                          <Form.Control style={{ resize: "none" }} as="textarea" rows={3} plaintext readOnly
      ...
      <ModalConfirm type='delete' component={t('ngen.taxonomy_one')} name={name} showModal={modalDelete}
                    onHide={() => setModalDelete(false)} ifConfirm={() => removeTaxonomy(url, name)}/>
    </React.Fragment>
  );
};
