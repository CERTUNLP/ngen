          ...
          <Card>
            <Card.Header>
              <Row>
                <Col>
                  <Card.Title as="h5">{t(
                    'ngen.user.profile')}: {profile.username}</Card.Title>
                </Col>
              </Row>
            </Card.Header>
            <Card.Body>
              <Table responsive>
                ...
                {profile.date_joined ?
                  <tr>
                    ...
                    <td>
                      <Form.Control plaintext readOnly
                                    defaultValue={profile.date_joined.slice(0,
                                        10) + ' ' +
                                      profile.date_joined.slice(11, 19)}/>
                    </td>
                  </tr>
                  :
                  <></>
                ...
                {profile.last_login ?
                  <tr>
                    ...
                    <td>
                      <Form.Control plaintext readOnly
                                    defaultValue={profile.last_login.slice(0,
                                        10) + ' ' +
                                      profile.last_login.slice(11, 19)}/>
                    </td>
                  </tr>
                  :
                  <></>
                ...
                {profile.priority ?
                  <tr>
                    ...
                    <td>
                      <FormGetName form={true} get={getPriority}
                                   url={profile.priority} key={1}/>
                    </td>
                  </tr>
                  :
                  <></>
                  ...
                  <tr>
                    ...
                    <td>
                      {Object.values(profile.groups).map((groupItem, index) => {
                        return (
                          <FormGetName form={true} get={getGroup}
                                       url={groupItem} key={index}/>
                        )
                      })
                      }
                    </td>
                ...
                {profile.user_permissions && profile.user_permissions.length > 0
                  ...
                  <tr>
                    ...
                    <td>
                      {Object.values(profile.user_permissions).
                        map((permissionItem, index) => {
                          return (
                            <FormGetName form={true} get={getPermission}
                                         url={permissionItem} key={index}/>
                          )
                        })
                      }
                    </td>
