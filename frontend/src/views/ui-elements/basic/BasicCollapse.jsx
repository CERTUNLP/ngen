    ...
    <React.Fragment>
      <Row className="btn-page">
        <Col sm={12}>
          ...
          <Card>
            <Card.Header>
              <Button onClick={() => setIsBasic(!isBasic)}
                      aria-controls="basic-collapse" aria-expanded={isBasic}>
                Collapse Link
              </Button>
              <Button onClick={() => setIsBasic(!isBasic)}>Collapse
                Button</Button>
            </Card.Header>
            <Collapse in={isBasic}>
        ...
        <Col sm={12}>
          ...
          <Button
            ...
            aria-expanded={isMultiTarget.findIndex(
              (item) => item === 'target1') > -1}
          >
