...
const CreateReport = () => {
  ...
  //Create
  const addReport = () => {
    postReport(body.problem, body.derived_problem, body.verification,
  ...
  return (
    <React.Fragment>
      <Alert showAlert={showAlert} resetShowAlert={() => setShowAlert(false)}
             component="report"/>
      <Row>
        <Navigation actualPosition={t('ngen.report.create')} path="/reports"
                    index={t('ngen.report')}/>
      </Row>
      <Row>
        <Col sm={12}>
          <Card>
            ...
            <Card.Body>
              ...
              <Row>
                <Col sm={12} lg={12}>
                  <FormReport body={body} setBody={setBody}
                              taxonomies={taxonomies} createOrEdit={addReport}/>
                </Col>
              </Row>
            </Card.Body>
          </Card>
