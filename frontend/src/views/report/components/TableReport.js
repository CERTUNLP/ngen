    ...
    <div>
      ...
      <ul className="list-group my-4">
        <Table responsive hover className="text-center">
          <thead>
          <tr>
            <Ordering field="taxonomy__name" label={t('ngen.taxonomy_one')} order={order} setOrder={setOrder}
                      setLoading={setLoading} letterSize={letterSize}/>
            <Ordering field="lang" label={t('w.lang')} order={order} setOrder={setOrder} setLoading={setLoading}
        ...
        <ModalConfirm type='delete' component={t('ngen.report')} name={""} showModal={remove}
