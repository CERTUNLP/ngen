    ...
    <div>
      ...
      <ul className="list-group my-4">
        <Table responsive hover className="text-center">
          <thead>
          <tr>
            <Ordering field="taxonomy__name" label={t('ngen.taxonomy_one')}
                      order={order} setOrder={setOrder}
                      setLoading={setLoading} letterSize={letterSize}/>
            <Ordering field="lang" label={t('w.lang')} order={order}
          ...
          {list.map((report, index) => {
            return (
              <tr key={index}>
                ...
                <td>{report.lang.toUpperCase()} ({t(
                  'w.language.' + report.lang)})
                </td>
                ...
                <td>
                  ...
                  <CrudButton type="delete"
                              onClick={() => modalDelete(report.url)}/>
                </td>
              </tr>
            )
          })}
        ...
        <ModalConfirm type="delete" component={t('ngen.report')} name={''}
                      showModal={remove}
                  ...
                  <Card.Body>
                    <Table responsive>
                      ...
                      <tr>
                        ...
                        <td>
                          <Form.Control plaintext readOnly
                                        defaultValue={report.derived_problem}/>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <Form.Control plaintext readOnly
                                        defaultValue={report.verification}/>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <Form.Control plaintext readOnly
                                        defaultValue={language[report.lang]}/>
                        </td>
                      </tr>
                      <tr>
                        <td>{t('w.info')}</td>
                        <td>
                          <Form.Control plaintext readOnly
                                        defaultValue={report.more_information}/>
                        </td>
                      </tr>
                      <tr>
                        <td>{t('ngen.taxonomy_one')}</td>
                        <td>
                          <CallBackendByName url={report.taxonomy}
                        ...
                        <td>
                          <Form.Control plaintext readOnly
                                        defaultValue={report.created
                                          ? report.created.slice(0, 10) + ' ' +
                                          report.created.slice(11, 19)
                                          : ''}/>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <Form.Control plaintext readOnly
                                        defaultValue={report.modified
                                          ? report.modified.slice(0, 10) + ' ' +
                                          report.modified.slice(11, 19)
                                          : ''}/>
                        </td>
                      </tr>
