...
const FormReport = ({ body, setBody, taxonomies, createOrEdit }) => {
  ...
  return (
    <Form>
      <Row>
        <Col sm={12} lg={6}>
          <SelectComponent controlId="exampleForm.ControlSelect1" label={t('ngen.taxonomy_one')} options={taxonomies}
                           value={selectTaxonomy} nameField="taxonomy"
                           onChange={completeField1} placeholder={t('ngen.taxonomy.one.select')}
                           setOption={setSelectTaxonomy} required={true}/>
        </Col>
        <Col sm={12} lg={6}>
          <SelectComponent controlId="exampleForm.ControlSelect1" label={t('w.lang')} options={languageOptions}
                           value={selectLanguage} nameField="lang"
                           onChange={completeField1} placeholder={t('w.lang.select')} setOption={setSelectLanguage}
                           required={true}/>
        </Col>
        <Col sm={12} lg={6}>
