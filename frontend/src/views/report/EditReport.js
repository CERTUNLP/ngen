...
const EditReport = () => {
  ...
  const editReport = () => {
    putReport(body.url, body.problem, body.derived_problem, body.verification, body.recommendations, body.more_information, body.lang, body.taxonomy).then((response) => {
