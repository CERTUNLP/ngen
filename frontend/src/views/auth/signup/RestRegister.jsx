    ...
    <React.Fragment>
      ...
      <Formik
        ...
        validationSchema={Yup.object().shape({
          email: Yup.string().
            email(t('signup.error.email.invalid')).
            max(255).
            required(t('signup.error.email.required')),
          username: Yup.string().required(t('signup.error.username.required')),
          password: Yup.string().
            max(255).
            required(t('signup.error.password.required')),
        })}
          ...
          <form noValidate onSubmit={handleSubmit}
            ...
            <div className="form-group mb-3">
              ...
              {touched.username && errors.username &&
                <small
                  className="text-danger form-text">{errors.username}</small>}
            </div>
            <div className="form-group mb-3">
              <input
                className="form-control"
