...
const ListEdge = (props) => {
  ...
  return (
    <div>
              ...
              <Row>
                ...
                <Col sm={12} lg={3}>
                  {props.sectionAddEdge ?
                    <CrudButton type="create" name={t('transition')}
                                onClick={() => setModalCreate(true)}/>
                    :
                    <><Button variant="outline-primary" disabled>{t(
                      'transitionAdd')}</Button></>
                  }
                </Col>
              </Row>
            </Card.Header>
                  ...
                  <Table responsive hover className="text-center">
                    ...
                    {edges ?
                      edges.map((edge, index) => {
                        return (
                          <RowEdge key={edge.url} url={edge.url} edges={edges}
                  ...
                  <Row className="justify-content-md-center">
                    <Col md="auto">
                      <AdvancedPagination countItems={countItems}
                                          updatePage={updatePage}></AdvancedPagination>
                    </Col>
                  </Row>
                </Card.Footer>
              </div>
      ...
      <Modal size="lg" show={modalCreate} onHide={() => closeModal()}
