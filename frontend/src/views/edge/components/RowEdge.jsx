  ...
  return (
    edge ?
      <React.Fragment>
        ...
        <ModalDetailEdge show={modalShow} edge={edge}
                         laterStateName={props.urlByStateName[edge.child]}
                         onHide={() => setModalShow(false)}/>
        <ModalEditEdge show={modalEdit} edge={edge}
                       nameState={props.urlByStateName[edge.child]}
                       childrens={props.listChildren}
                       onHide={() => setModalEdit(false)}
                       ifEdit={props.setEdgeUpdated}
                       setShowAlert={props.setShowAlert}/>
        <ModalConfirm showModal={modalDelete} type="delete"
                      component={t('ngen.edge_one')} name={edge.discr}
