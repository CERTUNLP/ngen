    ...
    <div>
      ...
      <ul className="list-group my-4">
        <Table responsive hover className="text-center">
              ...
              <tr key={index}>
                ...
                <td>
                  ...
                  <CrudButton type="delete"
                              onClick={() => handleShow(priority.name,
                                priority.url)}/>
                </td>
                  ...
                  <Card>
                    <Card.Header>
                      <Row>
                        <Col>
                          <Card.Title as="h5">{t(
                            'ngen.priority_one')}</Card.Title>
                          <span className="d-block m-t-5">{t(
                            'ngen.priority.detail')}</span>
                        </Col>
                        <Col sm={12} lg={4}>
                          <Link to="/priorities/edit" state={priority}>
                            <CrudButton type="edit"/>
                    ...
                    <Card.Body>
                      <Table responsive>
                        ...
                        <tr>
                          ...
                          <td>
                            <Form.Control plaintext readOnly
                                          defaultValue={priority.attend_time}/>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <Form.Control plaintext readOnly
                                          defaultValue={priority.solve_time}/>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <Form.Control plaintext readOnly
                                          defaultValue={priority.severity}/>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <Form.Control plaintext readOnly
                                          defaultValue={priority.notification_amount}/>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <Form.Control plaintext readOnly
                                          defaultValue={priority.created
                                            ? priority.created.slice(0, 10) +
                                            ' ' + priority.created.slice(11, 19)
                                            : ''}/>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <Form.Control plaintext readOnly
                                          defaultValue={priority.modified
                                            ? priority.modified.slice(0, 10) +
                                            ' ' +
                                            priority.modified.slice(11, 19)
                                            : ''}/>
                          </td>
                        </tr>
                      </Table>
          ...
          <ModalConfirm type="delete" component={t('ngen.priority_one')}
