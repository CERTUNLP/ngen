  ...
  return (
    <Card.Body>
      <Form>
        <Row>
          <Col sm={12} lg={4}>
            <Form.Group controlId="formGridAddress1">
              <Form.Label>{t('ngen.name_one')}<b style={{ color: 'red' }}>*</b>
              </Form.Label>
              <Form.Control
              ...
              {validateFieldText(body.name) ? '' :
                <div className="invalid-feedback"> {t(
                  'w.validate.character')}</div>}
            </Form.Group>
          </Col>
          <Col sm={12} lg={4}>
            <Form.Group controlId="formGridAddress1">
              ...
              <Form.Control
                ...
                onChange={(e) => completeField(e)}/>
              {validateNumber(body.severity) ? '' :
                <div className="invalid-feedback"> {t(
                  'w.validate.numbers')} </div>}
            </Form.Group>
          </Col>
          <Col sm={12} lg={4}>
            <Form.Group controlId="formGridAddress1">
              <Form.Label>{t('ngen.color')} <b style={{ color: 'red' }}>*</b>
              </Form.Label>
              <Form.Control
        ...
        <Row>
          <Col>
            <Form.Group controlId="formGridAddress1">
              ...
              isInvalid={body.attend_time_days !== '' &&
                !validateNumber(body.attend_time_days)}
          ...
          <Col>
            <Form.Group controlId="formGridAddress1">
              ...
              isInvalid={body.attend_time_hours !== '' &&
                !validateHours(body.attend_time_hours)}
              onChange={(e) => completeField(e)}/>
            </Form.Group>
          </Col>
          <Col>
            <Form.Group controlId="formGridAddress1">
              ...
              isInvalid={body.attend_time_minutes !== '' &&
                !validateMinutes(body.attend_time_minutes)}
              onChange={(e) => completeField(e)}/>
            </Form.Group>
          </Col>
        </Row>
        ...
        <Row>
          <Col>
            <Form.Group controlId="formGridAddress1">
              ...
              isInvalid={body.solve_time_days !== '' &&
                !validateNumber(body.solve_time_days)}
              onChange={(e) => completeField(e)}/>
          ...
          <Col>
            <Form.Group controlId="formGridAddress1">
              ...
              isInvalid={body.solve_time_hours !== '' &&
                !validateHours(body.solve_time_hours)}
          ...
          <Col>
            <Form.Group controlId="formGridAddress1">
              ...
              isInvalid={body.solve_time_minutes !== '' &&
                !validateMinutes(body.solve_time_minutes)}
        ...
        {activateBooton(body) ?
          <><Button variant="primary" onClick={createPriority}>{t(
            'button.save')}</Button></>
          : <><Button variant="primary" disabled>{t('button.save')}</Button></>}

        <Button variant="primary" href="/priorities">{t(
