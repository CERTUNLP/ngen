    ...
    <div>
      ...
      <ul className="list-group my-4">
        <Table responsive hover className="text-center">
                    ...
                    <Card.Body>
                      <Table responsive>
                        ...
                        <tr>
                          ...
                          <td>
                            <Form.Control plaintext readOnly
                                          defaultValue={priority.modified ? priority.modified.slice(0, 10) + " " + priority.modified.slice(11, 19) : ""}/>
                          </td>
                        </tr>
                      </Table>
                    </Card.Body>
          ...
          <ModalConfirm type='delete' component={t('ngen.priority_one')} name={deleteName} showModal={remove}
