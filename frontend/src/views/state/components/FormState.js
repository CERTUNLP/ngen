        ...
        <Card.Body>
          <Form>
            <Row>
              ...
              <Col>
                <SelectComponent controlId="exampleForm.ControlSelect1" label={t('w.attended')}
                                 options={attendedOptions} value={selectAttended} nameField="attended"
                                 onChange={completeField1} placeholder={t('selectOption')} setOption={setSelecAttended}
                                 required={true}/>
              </Col>
              <Col>
                <SelectComponent controlId="exampleForm.ControlSelect1" label={t('w.solved')} options={attendedOptions}
                                 value={selectSolved} nameField="solved"
                                 onChange={completeField1} placeholder={t('selectOption')} setOption={setSelectSolved}
                                 required={true}/>
              </Col>
            </Row>
