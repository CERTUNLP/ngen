                    ...
                    <Card.Body>
                      <Table responsive>
                          ...
                          <td>
                            {
                              state.children ? state.children.map((url) => {
                                  return (<CallBackendByName url={url}
                        ...
                        <tr>
                          ...
                          <td>
                            <Form.Control plaintext readOnly
                                          defaultValue={state.created
                                            ? state.created.slice(0, 10) + ' ' +
                                            state.created.slice(11, 19)
                                            : ''}/>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <Form.Control plaintext readOnly
                                          defaultValue={state.modified
                                            ? state.modified.slice(0, 10) +
                                            ' ' + state.modified.slice(11, 19)
                                            : ''}/>
                          </td>
                        </tr>
