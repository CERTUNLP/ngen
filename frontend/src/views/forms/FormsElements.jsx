                ...
                <Col md={6}>
                  <Form>
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                      ...
                      <Form.Text className="text-muted">We&apos;ll never share
                        your email with anyone else.</Form.Text>
                    </Form.Group>
              ...
              <Row>
                <Col sm={12} style={{ overflowX: 'auto' }}>
                  <Form className="d-inline-flex">
                    <Form.Group
                      className="d-inline-flex mx-3 align-items-center">
                      <Form.Label className="mb-0">Email:</Form.Label>
                      <Form.Control className="mx-2" plaintext readOnly
                                    defaultValue="email@example.com"/>
                    </Form.Group>
                    <Form.Group
                      className="d-inline-flex mr-5 mx-3 align-items-center">
                      <Form.Label className="mb-0">Password:</Form.Label>
                      <Form.Control className="mx-2" type="password"
            ...
            <Card.Body>
              <Row>
                <Col md={12}>
                  ...
                  <hr/>
                  <Form.Group className="mb-3">
                    <Form.Check type="checkbox" id="checkbox1"
                ...
                <Col md={6}>
                  ...
                  <hr/>
                  <Form.Group className="mb-3">
                    <Form.Check type="radio" label="Toggle this custom radio"
                                name="supportedRadios" id="supportedRadio3"/>
                    <Form.Check type="radio"
                                label="Or toggle this other custom radio"
                                name="supportedRadios" id="supportedRadio4"/>
                  </Form.Group>
                  ...
                  <Form.Group className="mb-3">
                    <Form.Check inline type="radio"
                                ...
                                name="supportedRadio" id="supportedRadio21"/>
                    <Form.Check inline type="radio"
                                label="Or toggle this other custom radio"
                                name="supportedRadio" id="supportedRadio22"/>
                  </Form.Group>
                </Col>
                <Col md={6}>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <InputGroup className="mb-3">
                ...
                <InputGroup.Text
                  id="basic-addon2">@example.com</InputGroup.Text>
              </InputGroup>
          ...
          <Card>
            ...
            <Card.Body>
              <InputGroup size="sm" className="mb-3">
                <InputGroup.Text
                  id="inputGroup-sizing-sm">Small</InputGroup.Text>
              ...
              <InputGroup size="lg">
                <InputGroup.Text
                  id="inputGroup-sizing-lg">Large</InputGroup.Text>
            ...
            <Card.Body>
              <Row>
                ...
                <Col md={6}>
                  ...
                  <hr/>
                  <InputGroup className="mb-3">
                    <DropdownButton as={InputGroup.Prepend} title="Dropdown"
                  ...
                  <InputGroup>
                    ...
                    <DropdownButton as={InputGroup.Append} title="Dropdown"
                  ...
                  <InputGroup className="mb-3">
                    <Dropdown as={InputGroup.Prepend}>
                      ...
                      <Dropdown.Menu>
                        ...
                        <Dropdown.Item hred="#/action-2">Another
                          action</Dropdown.Item>
                        <Dropdown.Item hred="#/action-3">Something
                          else</Dropdown.Item>
                      </Dropdown.Menu>
                    </Dropdown>
                    <FormControl aria-describedby="basic-addon1"/>
