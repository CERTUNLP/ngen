...
const CreateNetwork = () => {
  ...
  const createNetwork = () => {
    ...
    postNetwork(children, active, type, parent, network_entity, contacts,
  ...
  return (
    <React.Fragment>
      <Alert showAlert={showAlert} resetShowAlert={() => setShowAlert(false)}
             component="network"/>
      <Row>
        <Navigation actualPosition={t('ngen.network.create')} path="/networks"
        ...
        <Col sm={12}>
          <Card>
            <Card.Header>
              ...
              <span className="d-block m-t-5">{t('crud.add')} {t(
                'ngen.network_one')}</span>
            </Card.Header>
            <Card.Body>
              <FormCreateNetwork
