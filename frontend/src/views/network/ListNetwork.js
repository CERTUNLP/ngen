...
const ListNetwork = () => {
  ...
  useEffect(() => {
    getNetworks(currentPage, entitiesFilter + typeFilter + wordToSearch, order).then((response) => {
          ...
          <Card>
            <Card.Header>
              <Row>
                ...
                <Col sm={12} lg={8}>
                  <Search type={t('filter.cidr_domain')} setWordToSearch={setWordToSearch} wordToSearch={wordToSearch}
              ...
              <Collapse in={open}>
                ...
                <div id="example-collapse-text">
                  <Row>
                    <Col sm={4} lg={4}>
                      <FilterSelectUrl options={entities} itemName={t('ngen.entity_other')}
                                       partOfTheUrl="network_entity" itemFilter={entitiesFilter}
                                       itemFilterSetter={setEntitiesFilter} setLoading={setLoading}
                                       setCurrentPage={setCurrentPage}/>
                    </Col>
                    <Col sm={4} lg={4}>
                      <FilterSelect options={types} partOfTheUrl="type" setFilter={setTypeFilter}
                                    currentFilter={typeFilter} setLoading={setLoading}
