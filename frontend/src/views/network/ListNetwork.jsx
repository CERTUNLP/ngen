          ...
          <Card>
            <Card.Header>
              <Row>
                ...
                <Col sm={12} lg={8}>
                  <Search type={t('filter.cidr_domain')}
              ...
              <Collapse in={open}>
                ...
                <div id="example-collapse-text">
                  <Row>
                    <Col sm={4} lg={4}>
                      <FilterSelectUrl options={entities}
                    ...
                    <Col sm={4} lg={4}>
                      <FilterSelect options={types} partOfTheUrl="type"
            ...
            <Card.Body>
              <TableNetwork setIsModify={setIsModify} list={network}
                            loading={loading} currentPage={currentPage}
