                  ...
                  <Table responsive>
                      ...
                      <tr>
                        ...
                        <td>
                          <Form.Control plaintext readOnly
                                        defaultValue={props.network.cidr}/>
                        </td>
                      </tr>
                      :
                      <></>
                    ...
                    {props.network.domain ?
                      <tr>
                        ...
                        <td>
                          <Form.Control plaintext readOnly
                                        defaultValue={props.network.domain}/>
                        </td>
                      </tr>
                      :
                      <></>
                    ...
                    {props.network.children && props.network.children.length > 0
                      ...
                      <tr>
                        ...
                        <td>
                          {Object.values(props.network.children).
                            map((net, index) => {
                              return (
                    ...
                    {props.network.contacts && props.network.contacts.length > 0
                      ?
                      <tr>
                        <td>{t('ngen.related')} {t('ngen.contact_other')} </td>
                        <td>
                          {Object.values(props.network.contacts).
                            map((contactItem, index) => {
                              return (
                                <BadgeNetworkLabelContact url={contactItem}
                                                          key={index}/>
                              )
                            })
                          }
