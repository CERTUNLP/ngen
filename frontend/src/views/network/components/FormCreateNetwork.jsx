...
const FormCreateNetwork = (props) => {
  ...
  useEffect(() => {
    ...
    getMinifiedEntity().then((response) => {
  ...
  return (
    <React.Fragment>
      ...
      <Form>
        <Row>
          <Col sm={12} lg={4}>
            <SelectLabel set={props.setType} setSelect={setSelectedType}
                         options={typeOption}
                         value={selectedType} placeholder={t('ngen.type')}
                         required={true}/>
          </Col>
          <Col sm={12} lg={4}>
            <SelectLabel set={props.setNetwork_entity}
                         setSelect={setSelectEntity} options={entitiesOption}
        ...
        <Row>
          <Col sm={12} lg={8}>
            <Form.Group controlId="Form.Network.Contacts.Multiselect">
              <Form.Label>{t('ngen.contact_other')} <b
                style={{ color: 'red' }}>*</b></Form.Label>
              <Select
          ...
          <Row>
            <Col>
              <Form.Group>
                ...
                <DropdownState state={props.active}
                               setActive={props.setActive}></DropdownState>
              </Form.Group>
            </Col>
          </Row>
          :
        ...
        <Row>
          <Col>
            <Form.Group>
              ...
              <Button variant="primary" href="/networks">{t(
