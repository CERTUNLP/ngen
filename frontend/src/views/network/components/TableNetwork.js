    ...
    <React.Fragment>
      <Table responsive hover className="text-center">
        ...
        <tr>
          ...
          <Ordering field="type" label={t('ngen.type')} order={order} setOrder={setOrder} setLoading={setLoading}
                    letterSize={letterSize}/>
          <th style={letterSize}>{t('w.active')}</th>
          <Ordering field={t('ngen.entity')} label={t('ngen.entity')} order={order} setOrder={setOrder}
      ...
      <ModalConfirm type='delete' component='Red' name={cidr || domain} showModal={modalDelete}
                    onHide={() => setModalDelete(false)} ifConfirm={() => removeNetwork(url)}/>
      <ModalConfirm type='editState' component='Red' name={cidr || domain} state={active} showModal={modalState}
                    onHide={() => setModalState(false)} ifConfirm={() => switchState(url, active, cidr)}/>
