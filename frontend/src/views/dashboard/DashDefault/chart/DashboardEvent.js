  ...
  return (
    <div>
      <Card>
        ...
        <TableEvents events={list} taxonomyNames={taxonomyNames} feedNames={feedNames} disableDate={true}
                     disableCheckbox={true} disableDomain={true} disableCidr={true} disableTlp={true}
                     disableColumnEdit={true}
                     disableColumnDelete={true} disableTemplate={true} disableCheckboxAll={true} disableUuid={true}
                     disableDateModified={true} disableColumOption={false} disableColumView={false}/>
      </Card>
    </div>
  )
}
