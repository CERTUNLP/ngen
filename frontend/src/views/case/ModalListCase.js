...
const ModalListCase = (props) => {
  ...
  useEffect(() => {
    getCases(props.currentPage, props.stateFilter + props.tlpFilter + props.priorityFilter + props.wordToSearch, order).then((response) => {
  ...
  return (
    <Modal size="lg" show={props.showModalListCase} onHide={props.closeModal}
      ...
      <Modal.Body>
        ...
        <Row>
          <Col sm={12} lg={12}>
            <Search type={t('ngen.case_one')} setWordToSearch={props.setWordToSearch} wordToSearch={props.wordToSearch}
        ...
        <Row>
          <Col sm={4} lg={4}>
            <FilterSelectUrl options={props.priorities} itemName={t('ngen.priority_one')} partOfTheUrl="priority"
                             itemFilter={props.priorityFilter} itemFilterSetter={props.setPriorityFilter}
                             setLoading={setLoading} setCurrentPage={props.setCurrentPage}/>
          </Col>
          <Col sm={4} lg={4}>
            <FilterSelectUrl options={props.tlp} itemName={t('ngen.tlp')} partOfTheUrl="tlp"
                             itemFilter={props.tlpFilter} itemFilterSetter={props.setTlpFilter} setLoading={setLoading}
                             setCurrentPage={props.setCurrentPage}/>
          </Col>
          <Col sm={4} lg={4}>
            <FilterSelectUrl options={props.allStates} itemName={t('ngen.state_one')} partOfTheUrl="state"
                             itemFilter={props.stateFilter} itemFilterSetter={props.setStateFilter}
                             setLoading={setLoading} setCurrentPage={props.setCurrentPage}/>
          </Col>
        </Row>
        <div id="example-collapse-text">
          <TableCase cases={cases} loading={loading} selectedCases={props.selectedCases}
                     setSelectedCases={props.setSelectedCases} order={order} setOrder={setOrder}
                     ...
                     navigationRow={false} selectCase={true} handleClickRadio={props.handleClickRadio}
