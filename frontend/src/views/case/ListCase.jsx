...
const ListCase = () => {
  ...
  useEffect(() => {
    ...
    getCases(currentPage,
      priorityFilter + tlpFilter + stateFilter + wordToSearch, order).
      then((response) => {
  ...
  return (
    <React.Fragment>
          ...
          <Card>
            <Card.Header>
              <Row>
                ...
                <Col>
                  ...
                  <Button
                    disabled={(selectedCases.length <= 1).toString()}
                    size="lm"
              ...
              <Collapse in={open}>
                <div id="example-collapse-text">
                  ...
                  <Row>
                    <Col sm={4} lg={4}>
                      <FilterSelectUrl options={priorities}
                    ...
                    <Col sm={4} lg={4}>
                      <FilterSelectUrl options={tlps} itemName={t('ngen.tlp')}
                                       partOfTheUrl="tlp" itemFilter={tlpFilter}
                                       itemFilterSetter={setTlpFilter}
                                       setLoading={setLoading}
                                       setCurrentPage={setCurrentPage}/>
                    </Col>
                    <Col sm={4} lg={4}>
                      <FilterSelectUrl options={states}
            ...
            <Card.Body>
              <TableCase cases={cases} loading={loading}
                         ...
                         setSelectedCases={setSelectedCases} order={order}
                         setOrder={setOrder}
                         setIfModify={setIfModify} setLoading={setLoading}
                         priorityNames={priorityNames}
                         stateNames={stateNames} tlpNames={tlpNames}
                         userNames={userNames}
                         editColum={true} deleteColum={true}
                         navigationRow={true} buttonReturn={false}
      ...
      <ModalConfirm type="merge" component={t('ngen.case_other')}
                    name={selectedCases} showModal={showModal}
