...
const ModalListCase = (props) => {
  ...
  useEffect(() => {
    getCases(props.currentPage,
      props.stateFilter + props.tlpFilter + props.priorityFilter +
      props.wordToSearch, order).then((response) => {
  ...
  return (
    <Modal size="lg" show={props.showModalListCase} onHide={props.closeModal}
      ...
      <Modal.Body>
        ...
        <Row>
          <Col sm={4} lg={4}>
            <FilterSelectUrl options={props.priorities}
          ...
          <Col sm={4} lg={4}>
            <FilterSelectUrl options={props.tlp} itemName={t('ngen.tlp')}
                             partOfTheUrl="tlp"
          ...
          <Col sm={4} lg={4}>
            <FilterSelectUrl options={props.allStates}
                             itemName={t('ngen.state_one')} partOfTheUrl="state"
        ...
        <div id="example-collapse-text">
          <TableCase cases={cases} loading={loading}
                     selectedCases={props.selectedCases}
                     setSelectedCases={props.setSelectedCases} order={order}
                     setOrder={setOrder}
                     setLoading={setLoading} priorityNames={props.priorityNames}
                     stateNames={props.stateNames} tlpNames={props.tlpNames}
                     userNames={props.userNames}
                     editColum={false} deleteColum={false} detailModal={true}
      ...
      <Modal.Footer>
        ...
        <Button variant="outline-secondary" onClick={props.closeModal}>{t(
