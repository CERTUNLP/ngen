            ...
            <Card>
                ...
                <Card.Body>
                    <Form>
                        <Row>
                            <Col sm={12} lg={4}>
                                <SelectComponent controlId="exampleForm.ControlSelect1" label={t('ngen.taxonomy_one')} options={props.taxonomy} value={selectTaxonomy} nameField="event_taxonomy"
                    ...
                    <Form>
                        <Row>
                            <Col sm={12} lg={4}>
                                ...
                                <SelectComponent controlId="exampleForm.ControlSelect1" label={t('ngen.tlp')} options={props.tlp} value={selectTlp} nameField="case_tlp"
                            ...
                            <Col sm={12} lg={4}>
                                <SelectComponent controlId="exampleForm.ControlSelect1" label={t('ngen.state_other')} options={props.states} value={selectState} nameField="case_state"
                                    onChange={completeField1} placeholder={t('ngen.state.select')} setOption={setSelectState} required={true} />
                            </Col>
                        </Row>
                        <Row>
                            <Col sm={12} lg={4}>

                                <SelectComponent controlId="exampleForm.ControlSelect1" label={t('ngen.lifecycle_one')} options={lifeCicle} value={selectLifeCicle} nameField="case_lifecycle"
                                    onChange={completeField1} placeholder={t('ngen.lifecycle.select')} setOption={setSelectLifeCicle} required={true} />
                            </Col>
                        </Row>
                    </Form>
                </Card.Body>
