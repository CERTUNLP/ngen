...
const FormTemplate = (props) => {
  ...
  return (
    <React.Fragment>
            ...
            <Row>
              ...
              <Col sm={12} lg={4}>
                <SelectComponent controlId="exampleForm.ControlSelect1"
                                 ...
                                 options={props.states} value={selectState}
            ...
            <Row>
              <Col sm={12} lg={4}>
                <SelectComponent controlId="exampleForm.ControlSelect1"
                                 ...
                                 options={lifeCicle} value={selectLifeCicle}
                                 nameField="case_lifecycle"
                                 onChange={completeField1}
                                 placeholder={t('ngen.lifecycle.select')}
                                 setOption={setSelectLifeCicle}
                                 required={true}/>
              </Col>
            </Row>
          </Form>
      ...
      {props.body.event_taxonomy !== '-1' && props.body.event_feed !== '-1' &&
      props.body.case_tlp !== '-1'
      && props.body.priority !== '-1' && props.body.case_state !== '-1' &&
      props.body.address_value !== '' && !showErrorMessage ?
        <Button variant="primary" onClick={props.createTemplate}>{t(
          'button.save')}</Button>
        :
