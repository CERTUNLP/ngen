    ...
    <React.Fragment>
      ...
      <ul className="list-group my-4">
        <Table responsive hover className="text-center">
          <thead>
          <tr>
            <Ordering field="cidr,domain" label={t('ngen.affectedResources')}
                      order={order} setOrder={setOrder}
                      setLoading={setLoading} letterSize={letterSize}/>
            <Ordering field="event_taxonomy__name"
                      label={t('ngen.taxonomy_one')} order={order}
                      setOrder={setOrder}
                      setLoading={setLoading} letterSize={letterSize}/>
            <Ordering field="event_feed__name"
                      label={t('ngen.feed.information')} order={order}
                      setOrder={setOrder}
                      setLoading={setLoading} letterSize={letterSize}/>
            ...
            <Ordering field="priority" label={t('ngen.priority_one')}
                      order={order} setOrder={setOrder}
                      setLoading={setLoading} letterSize={letterSize}/>
            <Ordering field="case_state" label={t('ngen.state_one')}
                      order={order} setOrder={setOrder}
                      setLoading={setLoading} letterSize={letterSize}/>
            <Ordering field="case_tlp" label={t('ngen.tlp')} order={order}
                      setOrder={setOrder} setLoading={setLoading}
                      letterSize={letterSize}/>
            <Ordering field="matching_events_without_case_count"
              ...
              <tr key={index}>
                ...
                <td>
                  <ActiveButton active={+template.active}
                                onClick={() => modalChangeState(template.url,
                                  template.cidr, template.domain,
                ...
                <td>
                  ...
                  <CrudButton type="delete"
                              onClick={() => modalDelete(template.cidr,
                                template.domain,
                                taxonomyNames[template.event_taxonomy],
                                feedNames[template.event_feed], template.url)}/>
                </td>
              </tr>
            )
          })}
          ...
          <ModalConfirm type="editState" component={t('ngen.state_one')}
                        ...
                        state={dataTemplate.state} showModal={showTemplate}
                    ...
                    <Card.Body>
                      <Table responsive>
                        ...
                        <tr>
                          ...
                          <td>
                            <Form.Control plaintext readOnly
                                          defaultValue={template.case_lifecycle}/>
                          </td>
                        </tr>
                          ...
                          <td>
                            <Form.Control plaintext readOnly
                                          defaultValue={template.created
                                            ? template.created.slice(0, 10) +
                                            ' ' + template.created.slice(11, 19)
                                            : ''}/>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <Form.Control plaintext readOnly
                                          defaultValue={template.modified
                                            ? template.modified.slice(0, 10) +
                                            ' ' +
                                            template.modified.slice(11, 19)
                                            : ''}/>
                          </td>
                        </tr>
