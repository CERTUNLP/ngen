...
const ListTemplete = () => {
  ...
  useEffect(() => {
    ...
    getTemplates(currentPage, taxonomyFilter + feedFilter + wordToSearch, order).then((response) => {
          ...
          <Card>
            <Card.Header>
              <Row>
                ...
                <Col sm={12} lg={8}>
                  <Search type={t('cidr.domain')} setWordToSearch={setWordToSearch} wordToSearch={wordToSearch}
              ...
              <Collapse in={open}>
                <div id="example-collapse-text">
                  ...
                  <Row>
                    <Col sm={12} lg={4}>
                      <FilterSelectUrl options={feeds} itemName={t('ngen.feed_other')} partOfTheUrl="event_feed"
                                       itemFilter={feedFilter} itemFilterSetter={setFeedFilter}
                                       setLoading={setLoading}/>
                    </Col>
                    <Col sm={12} lg={4}>
                      <FilterSelectUrl options={taxonomies} itemName={t('ngen.taxonomy_one')}
                                       partOfTheUrl="event_taxonomy" itemFilter={taxonomyFilter}
            ...
            <Card.Body>
              <TableTemplete list={templete} loading={loading} order={order} setOrder={setOrder} setLoading={setLoading}
