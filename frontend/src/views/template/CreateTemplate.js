...
const CreateTemplate = () => {
  ...
  const createTemplate = () => {
    postTemplate(body.address_value, body.active, body.priority, body.event_taxonomy, body.event_feed, body.case_lifecycle, body.case_tlp, body.case_state).then(() => {
  ...
  return (
    <React.Fragment>
      ...
      {loading ?
        ...
        :
        <FormTemplate body={body} setBody={setBody} createTemplate={createTemplate} tlp={TLP} feeds={feeds}
                      taxonomy={taxonomy} priorities={priorities} states={states}/>
      }
    </React.Fragment>
  )
}
