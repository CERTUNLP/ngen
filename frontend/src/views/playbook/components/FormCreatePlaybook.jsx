...
} from '../../../utils/validators/playbooks'
    ...
    <React.Fragment>
      <Form>
            ...
            <Form.Group controlId="Form.Playbook.Name">
              ...
              <Form.Control
                ...
                isInvalid={(validateUnrequiredInput(props.name))
                  ...
                  : false}
              />
              {!validatePlaybookName(props.name) ?
        ...
        <Row>
          <Col sm={12} lg={6}>
            <Form.Group controlId="Form.Playbook.Taxonomy.Multiselect">
              <Form.Label>{t('ngen.taxonomy_other')} <b
        ...
        <Row>
          <Col>
            <Form.Group>
              {props.name !== '' && validatePlaybookName(props.name) &&
              (props.taxonomy.length > 0) ? //
                <><Button variant="primary"
                          onClick={props.ifConfirm}>{props.save}</Button></>
                :
