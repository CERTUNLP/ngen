...
const ModalListEvent = (props) => {
  ...
  useEffect(() => {
    getEvents(props.currentPage, props.taxonomyFilter + props.tlpFilter + props.feedFilter + props.wordToSearch + caseIsNull + parentIsNull, order, props.asNetworkAdmin)
      .then((response) => {
      ...
      <Modal.Body>
        ...
        <div id="example-collapse-text">
          <TableEvents
            ...
            taxonomyNames={props.taxonomyNames}
            feedNames={props.feedNames}
            tlpNames={props.tlpNames}
            disableCheckbox={false}
            formCaseCheckbok={false}
