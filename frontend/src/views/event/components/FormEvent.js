...
const FormEvent = (props) => {
  ...
  useEffect(() => {
    ...
    let listDefaultArtifact = props.listArtifact.filter(elemento => props.body.artifacts.includes(elemento.value)).map(elemento => ({
  ...
  return (
    <div>
            ...
            <Row>
              ...
              <Col sm={12} lg={4}>
                <SelectComponent controlId="exampleForm.ControlSelect1" label={t('ngen.taxonomy_one')}
                                 options={props.taxonomy} value={selectTaxonomy} nameField="taxonomy"
            ...
            <Row>
              <Col sm={12} lg={4}>
                <SelectComponent controlId="exampleForm.ControlSelect1" label={t('ngen.feed.information')}
                                 options={props.feeds} value={selectFeed} nameField="feed"
      ...
      <ModalListCase stateNames={allStates} showModalListCase={showModalListCase} modalCaseDetail={modalCaseDetail}
                     ...
                     tlpNames={props.tlpNames} userNames={props.userNames} handleClickRadio={handleClickRadio}
      ...
      {props.disableCardEvidence ?
        ""
        :
        <EvidenceCard evidences={props.evidence} setEvidences={props.setEvidence}
      ...
      <CreateArtifactModal show={modalCreate} onHide={() => setModalCreate(false)} value={value} setValue={setValue}
                           typeArtifact={typeArtifact} setTypeArtifact={setTypeArtifact}
