  ...
  const typeValue = [
    {
      ...
      isInvalid: JSON.parse(
        !validateSpace(props.value) || !validateEmail(props.value)),
    ...
    },
    {
      ...
      isInvalid: JSON.parse(
        !validateSpace(props.value) || !validateDomain(props.value)),
      condition: '',
    ...
    },
    {
      ...
      isInvalid: JSON.parse(
        !validateSpace(props.value) || !validateIP(props.value)),
    ...
    },
    {
      ...
      isInvalid: JSON.parse(
        !validateSpace(props.value) || !validateAutonomousSystem(props.value)),
    ...
    },
    {
      ...
      isInvalid: JSON.parse(
        !validateSpace(props.value) || !validateUserAgent(props.value)),
    ...
    },
    {
      ...
      isInvalid: JSON.parse(!validateSpace(props.value) ||
        (!validateHexadecimal32(props.value) &&
          !validateHexadecimal40(props.value)
          && !validateHexadecimal64(props.value) &&
          !validateHexadecimal128(props.value))),
      condition: JSON.parse(
        validateHexadecimal32(props.value) || validateHexadecimal40(props.value)
        || validateHexadecimal64(props.value) ||
        validateHexadecimal128(props.value)),
    ...
    return (
      <React.Fragment>
        ...
        <Form.Group controlId="formGridAddress1">
          ...
          {!props.value || username.condition ? '' : <div
            className="invalid-feedback"> {username.messageDanger} </div>}
        </Form.Group>
